...
const ACADEMY_POOL = {
    // ===== 🟢 초급 (Level 1) =====
    beginner: [
        { id: 'b1', title: "📘 주식이란 무엇인가?", content: "주식은 회사의 소유권을 잘게 쪼갠 증서입니다. 주식을 사면 그 회사의 주인(주주)이 되는 것이죠!", quiz: { question: "주식을 매수하면 갖게 되는 권리는?", options: ["채무 상환 의무", "회사 소유권(주주 권리)", "제품 무료 이용권", "건물 출입권"], answer: 1, reward: 100000 } },
        { id: 'b2', title: "📗 매수와 매도", content: "'매수'는 주식을 사는 것(Buy), '매도'는 주식을 파는 것(Sell)입니다. 기본 원칙은 '싸게 사서 비싸게 파는 것'입니다.", quiz: { question: "주식을 파는 행위를 무엇이라 할까요?", options: ["매수", "공매도", "매도", "대출"], answer: 2, reward: 100000 } },
        { id: 'b3', title: "📙 분산 투자", content: "'계란을 한 바구니에 담지 마라'는 유명한 투자 격언입니다. 여러 종목에 나누어 투자하면 위험을 줄일 수 있습니다.", quiz: { question: "분산 투자의 주된 목적은?", options: ["수익률 극대화", "위험(리스크) 감소", "세금 회피", "빠른 매매"], answer: 1, reward: 150000 } },
        { id: 'b4', title: "📕 뉴스와 주가", content: "좋은 뉴스(호재)가 나오면 주가가 오르고, 나쁜 뉴스(악재)가 나오면 주가가 내립니다.", quiz: { question: "회사에 좋은 뉴스가 나오면 주가는?", options: ["무조건 하락", "보통 상승", "변화 없음", "거래 정지"], answer: 1, reward: 150000 } },
        { id: 'b5', title: "📒 손절매와 익절매", content: "손절매는 손해를 보고 파는 것, 익절매는 이익이 난 상태에서 파는 것입니다.", quiz: { question: "손해를 감수하고 주식을 파는 것은?", options: ["익절매", "물타기", "손절매", "공매도"], answer: 2, reward: 200000 } },
        { id: 'b6', title: "📊 주가 차트 읽기", content: "주가 차트는 주식 가격의 변화를 그래프로 보여줍니다. 위로 올라가면 상승, 아래로 내려가면 하락입니다.", quiz: { question: "주가 차트에서 선이 위로 향하면?", options: ["주가 하락", "주가 상승", "거래량 증가", "배당금 지급"], answer: 1, reward: 100000 } },
        { id: 'b7', title: "💰 배당금이란?", content: "배당금은 회사가 번 이익의 일부를 주주에게 나눠주는 돈입니다. 주식을 보유만 해도 받을 수 있어요!", quiz: { question: "배당금은 누구에게 지급되나요?", options: ["회사 직원", "주주", "은행", "정부"], answer: 1, reward: 100000 } },
        { id: 'b8', title: "🏦 증권사란?", content: "증권사는 주식을 사고팔 수 있게 해주는 회사입니다. 은행과 비슷하지만, 주식 거래를 전문으로 합니다.", quiz: { question: "증권사의 주된 역할은?", options: ["대출 제공", "주식 거래 중개", "보험 판매", "부동산 관리"], answer: 1, reward: 100000 } },
    ],
    // ===== 🟡 중급 (Level 2) =====
    intermediate: [
        { id: 'i1', title: "📈 PER (주가수익비율)", content: "PER = 주가 ÷ 주당순이익. PER이 낮으면 저평가, 높으면 고평가일 수 있습니다. 업종마다 평균 PER이 다르니 비교해서 봐야 해요.", quiz: { question: "PER이 낮은 주식은 일반적으로?", options: ["고평가 상태", "저평가 가능성", "배당금이 높음", "거래량이 많음"], answer: 1, reward: 200000 } },
        { id: 'i2', title: "📉 PBR (주가순자산비율)", content: "PBR = 주가 ÷ 주당순자산. PBR이 1 미만이면 회사의 자산가치보다 주가가 싸다는 의미입니다.", quiz: { question: "PBR이 1 미만이면?", options: ["주가가 자산가치보다 높음", "주가가 자산가치보다 낮음", "배당률이 높음", "부채가 많음"], answer: 1, reward: 200000 } },
        { id: 'i3', title: "🔄 물타기 전략", content: "물타기란 보유 중인 주식 가격이 하락했을 때 추가 매수하여 평균 매수가를 낮추는 전략입니다. 위험할 수 있어요!", quiz: { question: "물타기의 목적은?", options: ["매도 시점 결정", "평균 매수가 하락", "배당금 증가", "분산 투자"], answer: 1, reward: 200000 } },
        { id: 'i4', title: "📊 거래량의 의미", content: "거래량은 일정 기간 동안 거래된 주식 수입니다. 거래량이 많으면 관심이 높다는 뜻이고, 추세의 신뢰도가 올라갑니다.", quiz: { question: "거래량 급증은 보통 무엇을 의미하나요?", options: ["시장 무관심", "강한 추세 신호", "배당금 지급일", "주식 분할"], answer: 1, reward: 200000 } },
        { id: 'i5', title: "🎯 목표가와 손절가", content: "투자 전에 '여기서 팔겠다'는 목표가와 '여기까지 떨어지면 손절하겠다'는 손절가를 미리 정해두는 것이 중요합니다.", quiz: { question: "투자 전 미리 정해야 할 것은?", options: ["친구의 의견", "목표가와 손절가", "뉴스 채널", "증권사 선택"], answer: 1, reward: 250000 } },
        { id: 'i6', title: "💹 시가총액", content: "시가총액 = 주가 × 총 발행 주식 수. 회사의 전체 가치를 나타내며, 시가총액이 클수록 대형주라고 합니다.", quiz: { question: "시가총액은 어떻게 계산하나요?", options: ["주가 ÷ 주식 수", "주가 × 주식 수", "이익 × 주가", "자산 - 부채"], answer: 1, reward: 200000 } },
        { id: 'i7', title: "🐂 강세장과 약세장", content: "주가가 지속적으로 오르는 시장을 강세장(Bull Market), 떨어지는 시장을 약세장(Bear Market)이라 합니다.", quiz: { question: "Bull Market은 어떤 시장인가요?", options: ["주가 하락 시장", "주가 상승 시장", "거래 정지 시장", "변동 없는 시장"], answer: 1, reward: 200000 } },
        { id: 'i8', title: "📋 재무제표 읽기", content: "재무제표는 회사의 '건강 진단서'입니다. 매출, 영업이익, 순이익을 통해 회사가 얼마나 잘 되고 있는지 파악할 수 있어요.", quiz: { question: "회사의 실제 돈 벌이를 보여주는 항목은?", options: ["자산총계", "영업이익", "자본금", "부채비율"], answer: 1, reward: 250000 } },
    ],
    // ===== 🔴 고급 (Level 3) =====
    advanced: [
        { id: 'a1', title: "🧮 ROE (자기자본이익률)", content: "ROE = 순이익 ÷ 자기자본 × 100. 투자한 자본 대비 얼마나 효율적으로 이익을 내는지 보여줍니다. 워런 버핏이 가장 중시하는 지표!", quiz: { question: "ROE가 높은 기업의 특징은?", options: ["부채가 많다", "자본 효율성이 높다", "주가가 싸다", "배당금이 없다"], answer: 1, reward: 300000 } },
        { id: 'a2', title: "📐 이동평균선", content: "이동평균선은 일정 기간의 평균 주가를 이은 선입니다. 단기선이 장기선을 위로 돌파하면 '골든크로스'(매수 신호)라 합니다.", quiz: { question: "골든크로스란 무엇인가요?", options: ["주가 폭락 신호", "단기선이 장기선을 상향 돌파", "거래량 급감", "배당 지급일"], answer: 1, reward: 300000 } },
        { id: 'a3', title: "🌊 변동성과 베타", content: "베타(β)는 시장 대비 주식의 변동성입니다. β > 1이면 시장보다 많이 움직이고, β < 1이면 적게 움직입니다.", quiz: { question: "베타가 1.5인 주식의 특성은?", options: ["시장보다 변동이 작음", "시장과 동일하게 변동", "시장보다 1.5배 많이 변동", "변동이 없음"], answer: 2, reward: 300000 } },
        { id: 'a4', title: "🔍 공매도란?", content: "공매도는 주식을 빌려서 먼저 팔고, 나중에 싸게 사서 갚는 투자 방법입니다. 주가 하락에 베팅하는 고급 기법이에요.", quiz: { question: "공매도로 수익을 얻으려면 주가가?", options: ["올라야 한다", "그대로여야 한다", "내려야 한다", "상관없다"], answer: 2, reward: 350000 } },
        { id: 'a5', title: "🏛️ ETF 투자", content: "ETF는 여러 주식을 한 바구니에 담은 상품입니다. 코스피200 ETF를 사면 200개 기업에 분산 투자하는 효과를 얻을 수 있어요.", quiz: { question: "ETF의 가장 큰 장점은?", options: ["높은 수수료", "손쉬운 분산 투자", "원금 보장", "무제한 레버리지"], answer: 1, reward: 300000 } },
        { id: 'a6', title: "⚖️ 리스크 대비 수익률", content: "샤프 비율은 위험 대비 초과 수익을 측정합니다. 같은 수익이라면 위험이 낮을수록 좋은 투자입니다.", quiz: { question: "같은 수익률이라면 더 좋은 투자는?", options: ["변동성이 큰 투자", "변동성이 작은 투자", "거래량이 많은 투자", "신규 상장 주식"], answer: 1, reward: 350000 } },
        { id: 'a7', title: "📉 데드크로스", content: "데드크로스는 단기 이동평균선이 장기 이동평균선을 하향 돌파하는 것입니다. 일반적으로 매도 신호로 해석됩니다.", quiz: { question: "데드크로스는 어떤 신호인가요?", options: ["매수 신호", "매도 신호", "보유 신호", "배당 신호"], answer: 1, reward: 300000 } },
        { id: 'a8', title: "🌐 환율과 주식", content: "원화가 약세(원/달러 환율 상승)이면 수출 기업에 유리하고, 원화 강세이면 수입 기업에 유리합니다.", quiz: { question: "원/달러 환율이 오르면 유리한 기업은?", options: ["수입 기업", "수출 기업", "내수 기업", "은행"], answer: 1, reward: 350000 } },
    ]
};
    ...
    submitPreStudyQuiz() {
        ...
        ACADEMY_DATA.forEach(item => {
            ...
            if (isCorrect) {
                ...
                feedback.textContent = `✅ 정답! +${item.quiz.reward.toLocaleString()}원`;
                ...
                feedback.textContent = `❌ 오답! 정답: ${correctAnswer}`;
    ...
    submitDailyQuiz() {
        ...
        this.currentDailyLessons.forEach(item => {
            ...
            if (isCorrect) {
                ...
                fb.textContent = `✅ 정답! +${item.quiz.reward.toLocaleString()}원`;
                fb.className = 'quiz-feedback correct';
                card.classList.add('quiz-correct');
                soundManager.playCorrect();
            } else {
                fb.textContent = `❌ 오답! 정답: ${item.quiz.options[item.quiz.answer]}`;
